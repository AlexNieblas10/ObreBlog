...
export const Post = ({
  ...
  return (
    <article
      ...
      className="md:w-[400px] h-[450px] w-full flex flex-col items-center bg-stone-200 rounded-2xl text-slate-700 duration-300 transition-transform hover:scale-105"
    >
      <Link className="w-full h-60" to={`/post/${id}`}>
        <img
          src={imgURL}
          alt="img post"
